        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="${pageContext.request.contextPath }/WEB-INF/jsp/backend/main.jsp" class="site_title"><i class="fa fa-paw"></i> <span>APP BMS</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> APP管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath }/WEB-INF/jsp/backend/applist.jsp">APP审核</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="${pageContext.request.contextPath }/logout2"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
