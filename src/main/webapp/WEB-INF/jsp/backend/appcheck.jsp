...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>查看并审核APP信息 <i class="fa fa-user"></i>${backendUser.username}</h2>
             <div class="clearfix"></div>
      </div>
      <div class="x_title">
            <h2>APP基础信息</h2>
      ...
      <div class="x_content1">
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/checkAppInfo?appid=${appInfo.id}" method="post">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${appInfo.ptname}" readonly="readonly">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${appInfo.tname1} --> ${appInfo.tname2} --> ${appInfo.tname3}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            	<input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${appInfo.sname}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
...
<%--			    <a href="${pageContext.request.contextPath}/download?path=${appVersion.downloadlink}" >下载</a>--%>
                  <a href="${pageContext.request.contextPath}/download?path=${appVersion.downloadlink}&fname=${appVersion.apkfilename}">下载</a>
			    </p>
			  </c:otherwise> 
            </c:choose> 
            </div>
