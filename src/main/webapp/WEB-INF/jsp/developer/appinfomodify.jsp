    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/updateAppInfo" method="post" enctype="multipart/form-data">
          <div style="margin: 0px auto;color: red;font-size: 20px">${error}</div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
             ...
             <div class="item form-group">
               ...
               <div class="col-md-6 col-sm-6 col-xs-12">
                 ...
                 <input type="hidden" name="oldPath" value="${appInfo.logopicpath}">
                 <input type="file" class="form-control col-md-7 col-xs-12" name="a_logoPicPath"  id="a_logoPicPath"/>
               </div>
             </div>
          </div>
...
<script>
    $(function(){
        ...
        function loadTwoType(){
            ...
            if(parentId!="")
            {
                $.get("${pageContext.request.contextPath}/getCategoryByPid",{"id":parentId},function(data){
                    for(var i=0;i<data.length;i++){
                        var node="<option value="+data[i].id+">"+data[i].categoryname+"</option>";
