						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> APP应用管理<span
									...
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath}/goSearchPage">APP维护</a></li>
										<li><a href="${pageContext.request.contextPath}/WEB-INF/jsp/developer/appinfoadd.jsp">新增APP</a></li>
									</ul>
								</li>

								<li><a><i class="fa fa-bank"></i> APP版本管理<span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath}/goAddVersion">新增版本</a></li>
									</ul>
								</li>
							</ul>
						</div>
